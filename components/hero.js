    ...
    <section className={styles.hero} id="home">
      <div className={styles.heroContainer}>
          ...
          >
            ...
            <a 
              target="_blank" 
              href="https://leetcode.com/KrishayNair/" 
              className={styles.socialLink}
              aria-label="LeetCode"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M16.102 17.93l-2.697 2.607c-.466.467-1.111.662-1.823.662s-1.357-.195-1.824-.662l-4.332-4.363c-.467-.467-.702-1.15-.702-1.863s.235-1.357.702-1.824l4.319-4.38c.467-.467 1.125-.645 1.837-.645s1.357.195 1.823.662l2.697 2.606c.514.515 1.365.497 1.9-.038.535-.536.553-1.387.038-1.901l-2.609-2.636a3.119 3.119 0 0 0-2.174-.903c-.838 0-1.629.338-2.21.913l-4.302 4.38c-1.584 1.584-1.584 4.219 0 5.804l4.332 4.363c1.582 1.582 4.242 1.582 5.827 0l2.609-2.636c.514-.514.516-1.366.038-1.9-.478-.534-1.387-.552-1.901-.038z"/>
              </svg>
            </a>
          </motion.div>
        </motion.div>
